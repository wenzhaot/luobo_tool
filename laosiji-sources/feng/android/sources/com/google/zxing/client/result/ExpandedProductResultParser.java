            ...
            if (ai != null) {
                ...
                switch (ai.hashCode()) {
                    ...
                    case 1537:
                        ...
                        break;
                    case 1567:
                        if (ai.equals(AgooConstants.ACK_REMOVE_PACKAGE)) {
                            obj = 2;
                            break;
                        }
                        break;
                    case 1568:
                        if (ai.equals(AgooConstants.ACK_BODY_NULL)) {
                            obj = 3;
                            break;
                        }
                        break;
                    case 1570:
                        if (ai.equals(AgooConstants.ACK_FLAG_NULL)) {
                            obj = 4;
                            break;
                        }
                        break;
                    case 1572:
                        if (ai.equals(AgooConstants.ACK_PACK_ERROR)) {
                            obj = 5;
                            break;
                        }
                        break;
