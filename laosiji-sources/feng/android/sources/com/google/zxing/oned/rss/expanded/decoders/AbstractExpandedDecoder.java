                ...
                switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 5)) {
                    ...
                    default:
                        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 7)) {
                            case 56:
                                return new AI013x0x1xDecoder(information, "310", AgooConstants.ACK_BODY_NULL);
                            case 57:
                                return new AI013x0x1xDecoder(information, "320", AgooConstants.ACK_BODY_NULL);
                            case 58:
                                return new AI013x0x1xDecoder(information, "310", AgooConstants.ACK_FLAG_NULL);
                            case 59:
                                return new AI013x0x1xDecoder(information, "320", AgooConstants.ACK_FLAG_NULL);
                            case 60:
                                return new AI013x0x1xDecoder(information, "310", AgooConstants.ACK_PACK_ERROR);
                            case 61:
                                return new AI013x0x1xDecoder(information, "320", AgooConstants.ACK_PACK_ERROR);
                            case 62:
