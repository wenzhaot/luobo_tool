    ...
    private static int byteCompaction(int mode, int[] codewords, int codeIndex, StringBuilder result) {
        ...
        if (mode == 901) {
            ...
            while (codeIndex < codewords[0] && !end) {
                ...
                if (nextCode == 900 || nextCode == 901 || nextCode == 902 || nextCode == BYTE_COMPACTION_MODE_LATCH_6 || nextCode == 928 || nextCode == BEGIN_MACRO_PDF417_OPTIONAL_FIELD || nextCode == MACRO_PDF417_TERMINATOR) {
                    codeIndex = codeIndex2 - 1;
                    end = true;
                    count = count2;
            ...
            while (codeIndex < codewords[0] && !end) {
                ...
                if (code < 900) {
                    ...
                    codeIndex = codeIndex2;
                } else if (code == 900 || code == 901 || code == 902 || code == BYTE_COMPACTION_MODE_LATCH_6 || code == 928 || code == BEGIN_MACRO_PDF417_OPTIONAL_FIELD || code == MACRO_PDF417_TERMINATOR) {
                    codeIndex = codeIndex2 - 1;
                    end = true;
                } else {
                    codeIndex = codeIndex2;
