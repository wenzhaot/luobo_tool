...
public enum CharacterSetECI {
    ...
    ISO8859_1((String) new int[]{1, 3}, (int) new String[]{f.a}),
    ...
    UnicodeBigUnmarked((String) 25, (int) new String[]{f.d, "UnicodeBig"}),
    UTF8((String) 26, (int) new String[]{"UTF-8"}),
    ASCII((String) new int[]{27, 170}, (int) new String[]{f.b}),
    Big5(28),
    ...
    public static CharacterSetECI getCharacterSetECIByValue(int value) throws FormatException {
        if (value >= 0 && value < IMediaPlayer.MEDIA_INFO_TIMED_TEXT_ERROR) {
