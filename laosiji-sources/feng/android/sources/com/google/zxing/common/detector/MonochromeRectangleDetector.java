...
public final class MonochromeRectangleDetector {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int deltaY = Math.max(1, height / AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS);
        int deltaX = Math.max(1, width / AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS);
        int bottom = height;
        int right = width;
    ...
    /* JADX WARNING: Missing block: B:34:0x0064, code:
            r3 = r1 - r4;
     */
    /* JADX WARNING: Missing block: B:35:0x0066, code:
            if (r1 >= r11) goto L_0x006a;
     */
    /* JADX WARNING: Missing block: B:36:0x0068, code:
