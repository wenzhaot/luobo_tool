...
public final class Detector {
    private static final int[] EXPECTED_CORNER_BITS = new int[]{3808, 476, TXLiveConstants.PLAY_WARNING_VIDEO_DISCONTINUITY, 1799};
    ...
    private Point getMatrixCenter() {
        ...
        int cy;
        try {
            cornerPoints = new WhiteRectangleDetector(this.image).detect();
