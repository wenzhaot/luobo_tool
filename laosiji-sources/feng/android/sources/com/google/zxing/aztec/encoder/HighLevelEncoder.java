...
public final class HighLevelEncoder {
    private static final int[][] CHAR_MAP = ((int[][]) Array.newInstance(Integer.TYPE, new int[]{5, AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS}));
    ...
    static {
        ...
        CHAR_MAP[1][32] = 1;
        for (c = 97; c <= IjkMediaMeta.FF_PROFILE_H264_HIGH_422; c++) {
            CHAR_MAP[1][c] = (c - 97) + 2;
        }
        CHAR_MAP[2][32] = 1;
        for (c = 48; c <= 57; c++) {
