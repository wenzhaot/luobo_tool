...
class C40Encoder implements Encoder {
    ...
    private static String encodeToCodewords(CharSequence sb, int startPos) {
        ...
        int v = (((c1 * 1600) + (c2 * 40)) + sb.charAt(startPos + 2)) + 1;
        char cw1 = (char) (v / AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS);
        char cw2 = (char) (v % AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS);
