...
public class ActivityVideoFinalpageBinding extends ViewDataBinding {
    ...
    static {
        sViewsWithIds.put(2131624726, 7);
        sViewsWithIds.put(2131624727, 8);
        sViewsWithIds.put(2131624728, 9);
        sViewsWithIds.put(2131624240, 10);
        sViewsWithIds.put(2131624241, 11);
        sViewsWithIds.put(2131624242, 12);
        sViewsWithIds.put(2131624245, 13);
        sViewsWithIds.put(2131624247, 14);
        sViewsWithIds.put(2131624248, 15);
        sViewsWithIds.put(2131624249, 16);
        sViewsWithIds.put(2131624250, 17);
    }

    public ActivityVideoFinalpageBinding(DataBindingComponent bindingComponent, View root) {
        super(bindingComponent, root, 3);
        Object[] bindings = mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds);
        this.bottomLine = (RelativeLayout) bindings[11];
        this.commentText = (TextView) bindings[5];
        this.commentText.setTag(null);
        this.divider = (View) bindings[10];
        this.headerEmptyView = (EmptyView) bindings[8];
        this.ivForward = (ImageView) bindings[14];
        this.ivMessage = (ImageView) bindings[3];
        this.ivMessage.setTag(null);
        this.llContent = (LinearLayout) bindings[0];
        ...
        this.rlComment = (RelativeLayout) bindings[13];
        this.rlPraise = (RelativeLayout) bindings[12];
        this.topLine = (RelativeLayout) bindings[17];
        ...
        this.tvSendMessage = (TextView) bindings[15];
        this.videoPlayer = (FengVideoPlayer) bindings[7];
        setRootTag(root);
        invalidateAll();
    }
    ...
    public static ActivityVideoFinalpageBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    public static ActivityVideoFinalpageBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, DataBindingComponent bindingComponent) {
        return (ActivityVideoFinalpageBinding) DataBindingUtil.inflate(inflater, 2130903148, root, attachToRoot, bindingComponent);
    }

    public static ActivityVideoFinalpageBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    public static ActivityVideoFinalpageBinding inflate(LayoutInflater inflater, DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(2130903148, null, false), bindingComponent);
    }

    public static ActivityVideoFinalpageBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    public static ActivityVideoFinalpageBinding bind(View view, DataBindingComponent bindingComponent) {
        if ("layout/activity_video_finalpage_0".equals(view.getTag())) {
            return new ActivityVideoFinalpageBinding(bindingComponent, view);
        }
