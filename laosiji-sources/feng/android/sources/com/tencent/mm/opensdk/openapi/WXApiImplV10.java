...
final class WXApiImplV10 implements IWXAPI {
    ...
    private boolean sendInvoiceAuthInsert(Context context, BaseReq baseReq) {
        ...
        Cursor query = contentResolver.query(parse, null, null, new String[]{this.appId, PushConstants.PUSH_TYPE_UPLOAD_LOG, encode}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendSubscribeMessage(Context context, BaseReq baseReq) {
        ...
        Cursor query = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, PushConstants.PUSH_TYPE_THROUGH_MESSAGE, String.valueOf(req.scene), req.templateID, req.reserved}, null);
        if (query != null) {
            query.close();
        }
        return true;
