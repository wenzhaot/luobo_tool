...
public class IjkMediaMeta {
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        ArrayList parcelableArrayList2 = ijkMediaMeta.getParcelableArrayList(IJKM_KEY_PROGRAMS);
        if (parcelableArrayList2 == null) {
            return ijkMediaMeta;
        }
        Iterator it2 = parcelableArrayList2.iterator();
        while (it2.hasNext()) {
            bundle2 = (Bundle) it2.next();
            if (bundle2 != null) {
                IjkBitrateItem ijkBitrateItem = new IjkBitrateItem();
                ijkBitrateItem.index = Integer.parseInt(bundle2.getString(IJKM_KEY_BITRATE_INDEX, PushConstants.PUSH_TYPE_NOTIFY));
                ijkBitrateItem.width = Integer.parseInt(bundle2.getString("width", PushConstants.PUSH_TYPE_NOTIFY));
                ijkBitrateItem.height = Integer.parseInt(bundle2.getString("height", PushConstants.PUSH_TYPE_NOTIFY));
                ijkBitrateItem.bitrate = Integer.parseInt(bundle2.getString(IJKM_KEY_BITRATE, PushConstants.PUSH_TYPE_NOTIFY));
