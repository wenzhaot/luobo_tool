            ...
            if (this.i) {
                try {
                    ...
                    if (regist != null) {
                        ...
                        replace = "2.1.1".replace(FileUtils.FILE_EXTENSION_SEPARATOR, "");
                        String replace3 = "2.3.0".replace(FileUtils.FILE_EXTENSION_SEPARATOR, "");
                        replace2 = regist.replace(FileUtils.FILE_EXTENSION_SEPARATOR, "");
                        if (replace2.length() == 2) {
                            replace2 = replace2 + PushConstants.PUSH_TYPE_NOTIFY;
                ...
                try {
                    ...
                    if (replace2 == null) {
                        ...
                        objArr2[2] = Integer.valueOf(com.tencent.bugly.crashreport.common.info.a.L());
