...
public final class e implements UncaughtExceptionHandler {
    ...
    private b b;
    private a c;
    private com.tencent.bugly.imsdk.crashreport.common.info.a d;
    private UncaughtExceptionHandler e;
    private UncaughtExceptionHandler f;
    private boolean g = false;
    private int j;

    public e(Context context, b bVar, a aVar, com.tencent.bugly.imsdk.crashreport.common.info.a aVar2) {
        this.a = context;
        this.b = bVar;
        this.c = aVar;
        this.d = aVar2;
    ...
    private CrashDetailBean b(Thread thread, Throwable th, boolean z, String str, byte[] bArr) {
        ...
        try {
            ...
            crashDetailBean.A = thread.getName() + l.s + thread.getId() + l.t;
