package com.tencent.bugly.imsdk.crashreport.biz;
...
public final class a {
    ...
    public final void a(int i, boolean z, long j) {
        ...
        if (a == null || a.c().h || i == 1 || i == 3) {
            ...
            com.tencent.bugly.imsdk.crashreport.common.info.a a2 = com.tencent.bugly.imsdk.crashreport.common.info.a.a(this.a);
    ...
    private synchronized void c() {
        ...
        synchronized (this) {
            if (this.d) {
                t a = t.a();
                if (a != null) {
                    com.tencent.bugly.imsdk.crashreport.common.strategy.a a2 = com.tencent.bugly.imsdk.crashreport.common.strategy.a.a();
                    if (a2 != null && (!a2.b() || a.b(1001))) {
                        boolean z2;
                        List list;
                        String str = com.tencent.bugly.imsdk.crashreport.common.info.a.a(this.a).d;
                        ...
                        if (a3 != null) {
                            ...
                            if (i2 > 15) {
                                w.d("[UserInfo] Upload user info too many times in 10 min: %d", Integer.valueOf(i2));
                                z2 = false;
                            } else {
                                z2 = true;
                            }
                        ...
                        if (!z2 || list2.size() == 0) {
                            ...
                            w.c("[UserInfo] Upload user info(size: %d)", Integer.valueOf(list2.size()));
                            j a4 = com.tencent.bugly.imsdk.proguard.a.a(list2, this.c == 1 ? 1 : 2);
                            if (a4 == null) {
                                w.d("[UserInfo] Failed to create UserInfoPackage.", new Object[0]);
                            } else {
                                byte[] a5 = com.tencent.bugly.imsdk.proguard.a.a(a4);
                                if (a5 == null) {
                                    w.d("[UserInfo] Failed to encode data.", new Object[0]);
                                } else {
                                    al a6 = com.tencent.bugly.imsdk.proguard.a.a(this.a, a.a ? 840 : FengConstant.IMAGEMIDDLEWIDTH, a5);
                                    if (a6 == null) {
    ...
    /* JADX WARNING: Missing block: B:36:0x008c, code:
            r0 = th;
     */
    public final java.util.List<com.tencent.bugly.imsdk.crashreport.biz.UserInfoBean> a(java.lang.String r10) {
        /*
        r9 = this;
        r7 = 0;
        r0 = com.tencent.bugly.imsdk.proguard.y.a(r10);	 Catch:{ Throwable -> 0x00d4, all -> 0x00ce }
        if (r0 == 0) goto L_0x0020;
    L_0x0007:
        r3 = r7;
    L_0x0008:
        r0 = com.tencent.bugly.imsdk.proguard.o.a();	 Catch:{ Throwable -> 0x00d4, all -> 0x00ce }
        r1 = "t_ui";
        r2 = 0;
        r4 = 0;
        r5 = 0;
    ...
    L_0x0052:
        ...
        r1 = r8;
    L_0x0054:
        r2 = com.tencent.bugly.imsdk.proguard.w.a(r0);	 Catch:{ all -> 0x00d1 }
    ...
    L_0x0081:
        ...
        com.tencent.bugly.imsdk.proguard.w.d(r1, r2);	 Catch:{ Throwable -> 0x0052, all -> 0x008c }
        goto L_0x0042;
    L_0x008c:
        r0 = move-exception;
    L_0x008d:
    ...
    L_0x009d:
        ...
        r0 = com.tencent.bugly.imsdk.proguard.o.a();	 Catch:{ Throwable -> 0x0052, all -> 0x008c }
        r1 = "t_ui";
        r3 = 0;
        r4 = 0;
        r5 = 1;
    ...
    L_0x00d4:
        ...
        goto L_0x0054;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.bugly.imsdk.crashreport.biz.a.a(java.lang.String):java.util.List<com.tencent.bugly.imsdk.crashreport.biz.UserInfoBean>");
    }
