...
public final class i {
    ...
    public final byte[] b() {
        Object obj = new byte[this.a.position()];
        System.arraycopy(this.a.array(), 0, obj, 0, this.a.position());
        return obj;
    }
    ...
    private void b(byte b, int i) {
        ...
        } else if (i < AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS) {
