...
class d {
    ...
    L_0x009c:
        ...
        r1 = r0;
    L_0x00cb:
        r5 = new java.io.ByteArrayOutputStream;	 Catch:{ Throwable -> 0x015f }
        r5.<init>();	 Catch:{ Throwable -> 0x015f }
        r0 = r3.toString();	 Catch:{ Throwable -> 0x015f }
        r6 = "UTF-8";
        r0 = r0.getBytes(r6);	 Catch:{ Throwable -> 0x015f }
        r6 = r0.length;	 Catch:{ Throwable -> 0x015f }
        r3 = r3.length();	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x00ef:
        r0 = com.tencent.stat.common.e.a(r0);	 Catch:{ Throwable -> 0x015f }
        r3 = new org.apache.http.entity.ByteArrayEntity;	 Catch:{ Throwable -> 0x015f }
        r3.<init>(r0);	 Catch:{ Throwable -> 0x015f }
        r2.setEntity(r3);	 Catch:{ Throwable -> 0x015f }
        r0 = r12.a;	 Catch:{ Throwable -> 0x015f }
        r2 = r0.execute(r2);	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x010f:
        r0 = r2.getEntity();	 Catch:{ Throwable -> 0x015f }
        r1 = r2.getStatusLine();	 Catch:{ Throwable -> 0x015f }
        r1 = r1.getStatusCode();	 Catch:{ Throwable -> 0x015f }
        r6 = r0.getContentLength();	 Catch:{ Throwable -> 0x015f }
        r3 = c;	 Catch:{ Throwable -> 0x015f }
        r4 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x015f }
        r4.<init>();	 Catch:{ Throwable -> 0x015f }
        r8 = "recv response status code:";
        r4 = r4.append(r8);	 Catch:{ Throwable -> 0x015f }
        r4 = r4.append(r1);	 Catch:{ Throwable -> 0x015f }
        r8 = ", content length:";
        r4 = r4.append(r8);	 Catch:{ Throwable -> 0x015f }
        r4 = r4.append(r6);	 Catch:{ Throwable -> 0x015f }
        r4 = r4.toString();	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x017f:
        r3 = 4;
        r3 = new byte[r3];	 Catch:{ Throwable -> 0x015f }
        r5.write(r3);	 Catch:{ Throwable -> 0x015f }
        r3 = new java.util.zip.GZIPOutputStream;	 Catch:{ Throwable -> 0x015f }
        r3.<init>(r5);	 Catch:{ Throwable -> 0x015f }
        r3.write(r0);	 Catch:{ Throwable -> 0x015f }
        r3.close();	 Catch:{ Throwable -> 0x015f }
        r0 = r5.toByteArray();	 Catch:{ Throwable -> 0x015f }
        r3 = 0;
        r4 = 4;
        r3 = java.nio.ByteBuffer.wrap(r0, r3, r4);	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x01cb:
        ...
        goto L_0x017f;
    L_0x01d5:
        r0 = c;	 Catch:{ Throwable -> 0x015f }
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x015f }
        r2.<init>();	 Catch:{ Throwable -> 0x015f }
        r3 = "Server response error code:";
        r2 = r2.append(r3);	 Catch:{ Throwable -> 0x015f }
        r1 = r2.append(r1);	 Catch:{ Throwable -> 0x015f }
        r1 = r1.toString();	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x01f4:
        r3 = r0.getContent();	 Catch:{ Throwable -> 0x015f }
        r4 = new java.io.DataInputStream;	 Catch:{ Throwable -> 0x015f }
        r4.<init>(r3);	 Catch:{ Throwable -> 0x015f }
        r6 = r0.getContentLength();	 Catch:{ Throwable -> 0x015f }
        r0 = (int) r6;	 Catch:{ Throwable -> 0x015f }
        r0 = new byte[r0];	 Catch:{ Throwable -> 0x015f }
        r4.readFully(r0);	 Catch:{ Throwable -> 0x015f }
        r3.close();	 Catch:{ Throwable -> 0x015f }
        r4.close();	 Catch:{ Throwable -> 0x015f }
        r4 = "Content-Encoding";
        r2 = r2.getFirstHeader(r4);	 Catch:{ Throwable -> 0x015f }
        if (r2 == 0) goto L_0x022b;
    L_0x0216:
        r4 = r2.getValue();	 Catch:{ Throwable -> 0x015f }
        r6 = "gzip,rc4";
        r4 = r4.equalsIgnoreCase(r6);	 Catch:{ Throwable -> 0x015f }
        if (r4 == 0) goto L_0x02b9;
    L_0x0223:
        r0 = com.tencent.stat.common.k.a(r0);	 Catch:{ Throwable -> 0x015f }
        r0 = com.tencent.stat.common.e.b(r0);	 Catch:{ Throwable -> 0x015f }
    L_0x022b:
        if (r1 != r9) goto L_0x0317;
    L_0x022d:
        r1 = new java.lang.String;	 Catch:{ Throwable -> 0x030c }
        r2 = "UTF-8";
        r1.<init>(r0, r2);	 Catch:{ Throwable -> 0x030c }
        r0 = c;	 Catch:{ Throwable -> 0x030c }
        r0.d(r1);	 Catch:{ Throwable -> 0x030c }
        r0 = new org.json.JSONObject;	 Catch:{ Throwable -> 0x030c }
        r0.<init>(r1);	 Catch:{ Throwable -> 0x030c }
        r2 = "cfg";
        r2 = r0.isNull(r2);	 Catch:{ Throwable -> 0x030c }
        if (r2 != 0) goto L_0x0252;
    L_0x0248:
        r2 = "cfg";
        r2 = r0.getJSONObject(r2);	 Catch:{ Throwable -> 0x030c }
    ...
    L_0x025b:
        ...
        if (r2 != 0) goto L_0x02af;
    L_0x0264:
        r2 = c;	 Catch:{ Throwable -> 0x030c }
        r4 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x030c }
        r4.<init>();	 Catch:{ Throwable -> 0x030c }
        r6 = "get mid respone:";
        r4 = r4.append(r6);	 Catch:{ Throwable -> 0x030c }
        r1 = r4.append(r1);	 Catch:{ Throwable -> 0x030c }
        r1 = r1.toString();	 Catch:{ Throwable -> 0x030c }
        r2.d(r1);	 Catch:{ Throwable -> 0x030c }
        r1 = "et";
        r1 = r0.getInt(r1);	 Catch:{ Throwable -> 0x030c }
        r2 = com.tencent.stat.a.f.SESSION_ENV;	 Catch:{ Throwable -> 0x030c }
        r2 = r2.a();	 Catch:{ Throwable -> 0x030c }
    ...
    L_0x0296:
        r0 = c;	 Catch:{ Throwable -> 0x030c }
        r2 = new java.lang.StringBuilder;	 Catch:{ Throwable -> 0x030c }
        r2.<init>();	 Catch:{ Throwable -> 0x030c }
        r4 = "error type for st:";
        r2 = r2.append(r4);	 Catch:{ Throwable -> 0x030c }
        r1 = r2.append(r1);	 Catch:{ Throwable -> 0x030c }
        r1 = r1.toString();	 Catch:{ Throwable -> 0x030c }
    ...
    L_0x02dd:
        ...
        goto L_0x022b;
    L_0x02e3:
        r2 = r2.getValue();	 Catch:{ Throwable -> 0x015f }
        r4 = "rc4";
        r2 = r2.equalsIgnoreCase(r4);	 Catch:{ Throwable -> 0x015f }
        if (r2 == 0) goto L_0x022b;
    L_0x02f0:
        r0 = com.tencent.stat.common.e.b(r0);	 Catch:{ Throwable -> 0x015f }
        goto L_0x022b;
    L_0x02f6:
        r1 = "mid";
        r1 = r0.isNull(r1);	 Catch:{ Throwable -> 0x030c }
        if (r1 != 0) goto L_0x02af;
    L_0x02ff:
        r1 = f;	 Catch:{ Throwable -> 0x030c }
        r2 = "mid";
        r0 = r0.getString(r2);	 Catch:{ Throwable -> 0x030c }
        com.tencent.stat.StatMid.updateDeviceInfo(r1, r0);	 Catch:{ Throwable -> 0x030c }
        goto L_0x02af;
    L_0x030c:
        r0 = move-exception;
        r1 = c;	 Catch:{ Throwable -> 0x015f }
        r0 = r0.toString();	 Catch:{ Throwable -> 0x015f }
    ...
    L_0x0317:
        ...
        r4 = r4.append(r6);	 Catch:{ Throwable -> 0x015f }
        r1 = r4.append(r1);	 Catch:{ Throwable -> 0x015f }
        r4 = ", error:";
        r1 = r1.append(r4);	 Catch:{ Throwable -> 0x015f }
        r4 = new java.lang.String;	 Catch:{ Throwable -> 0x015f }
        r6 = "UTF-8";
        r4.<init>(r0, r6);	 Catch:{ Throwable -> 0x015f }
        r0 = r1.append(r4);	 Catch:{ Throwable -> 0x015f }
        r0 = r0.toString();	 Catch:{ Throwable -> 0x015f }
