...
public class StatConfig {
    ...
    public static void setAppKey(Context context, String str) {
        ...
        } else if (str == null || str.length() > AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS) {
    ...
    public static void setAppKey(String str) {
        ...
        } else if (str.length() > AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS) {
