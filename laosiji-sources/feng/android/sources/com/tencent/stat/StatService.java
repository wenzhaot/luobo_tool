...
public class StatService {
    ...
    static JSONObject a() {
        ...
        try {
            ...
            if (StatConfig.b.d != 0) {
                jSONObject2.put(NotifyType.VIBRATE, StatConfig.b.d);
            }
            jSONObject.put(Integer.toString(StatConfig.b.a), jSONObject2);
            jSONObject2 = new JSONObject();
            if (StatConfig.a.d != 0) {
                jSONObject2.put(NotifyType.VIBRATE, StatConfig.a.d);
            }
                ...
                if (a == null && b(context)) {
                    if (f.a(context)) {
                        ...
                        if (StatConfig.isAutoExceptionCaught()) {
                            Thread.setDefaultUncaughtExceptionHandler(new g(StubApp.getOrigApplicationContext(context.getApplicationContext())));
                        } else {
    ...
    static void a(Context context, Map<String, ?> map) {
        ...
        try {
            e aVar = new a(context, a(context, false), map);
            if (c(context) != null) {
