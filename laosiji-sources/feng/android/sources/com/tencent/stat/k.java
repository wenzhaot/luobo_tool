...
class k implements Runnable {
    ...
    public void run() {
        try {
            ...
            if (this.a.a() == f.ERROR || this.a.d().length() <= StatConfig.getMaxReportEventLength()) {
                if (StatConfig.getMaxSessionStatReportCount() > 0) {
                    if (StatConfig.getCurSessionStatReportCount() >= StatConfig.getMaxSessionStatReportCount()) {
                        StatService.i.e((Object) "Times for reporting events has reached the limit of StatConfig.getMaxSessionStatReportCount() in current session.");
                        return;
                    }
                    StatConfig.c();
                }
                ...
                if (com.tencent.stat.common.k.h(c)) {
                    ...
                    switch (this.b) {
                        ...
                        case PERIOD:
                            ...
                            if (Long.valueOf(Long.valueOf(valueOf2.longValue() - valueOf.longValue()).longValue() / OkHttpUtils.DEFAULT_MILLISECONDS).longValue() > ((long) StatConfig.getSendPeriodMinutes())) {
                                n.a(c).a(-1);
                        ...
                        case ONLY_WIFI_NO_CACHE:
                            ...
                            return;
                        default:
                            StatService.i.error("Invalid stat strategy:" + StatConfig.getStatSendStrategy());
                            return;
                    }
                    StatService.i.e(th);
                }
            ...
            StatService.i.e("Event length exceed StatConfig.getMaxReportEventLength(): " + StatConfig.getMaxReportEventLength());
        } catch (Exception e) {
            StatService.i.e(e);
        } catch (Object th) {
            StatService.i.e(th);
