...
public class a {
    ...
    private Handler i = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message message) {
            if (a.this.a != null) {
                switch (message.what) {
                    case 0:
                        a.this.a.onNetSuccess(a.this);
                        return;
                    case 1:
                        a.this.a.onNetFailed(a.this, (String) message.obj, message.arg1);
                        return;
                    default:
                        return;
                }
        ...
        this.g = new Thread("getPlayInfo") {
            public void run() {
                try {
                    ...
                    String a = a.this.a(str6, str7, i4, str8);
                    if (a != null) {
                        format = format + "?" + a;
                    }
                    ...
                    if (httpURLConnection.getResponseCode() == 200) {
                        ...
                        while (true) {
                            ...
                            if (readLine != null) {
                                ...
                                a.this.a(stringBuilder.toString());
                                return;
                            }
                        }
                    }
    ...
    private String a(String str, String str2, int i, String str3) {
        ...
        if (str2 != null) {
            stringBuilder.append("us=" + str2 + "&");
        }
        if (str3 != null) {
            stringBuilder.append("sign=" + str3 + "&");
        }
        if (i >= 0) {
            stringBuilder.append("exper=" + i + "&");
        }
