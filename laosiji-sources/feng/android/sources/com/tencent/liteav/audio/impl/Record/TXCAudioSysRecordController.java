...
public class TXCAudioSysRecordController extends c implements g, c {
    ...
    public int startRecord(Context context) {
        ...
        if (this.mIsCustomRecord) {
            ...
            if (this.mAECType == TXEAudioDef.TXE_AEC_SYSTEM) {
                if (this.mSampleRate > com.tencent.liteav.basic.d.b.a().e()) {
                    this.mRecordSampleRate = com.tencent.liteav.basic.d.b.a().f();
                } else {
                    this.mRecordSampleRate = com.tencent.liteav.basic.d.b.a().e();
                }
        ...
        if (!(this.mWeakRecordListener == null || this.mWeakRecordListener.get() == null)) {
            ((e) this.mWeakRecordListener.get()).onRecordError(TXEAudioDef.TXE_AUDIO_NOTIFY_AUDIO_INFO, (this.mAECType == TXEAudioDef.TXE_AEC_SYSTEM ? "SYSTEM-AEC," : "NO-AEC,") + "采样率(" + this.mRecordSampleRate + "|" + this.mSampleRate + "),声道数" + this.mChannels);
        }
        return 0;
    }
    ...
    public synchronized void onAudioRecordError(int i, String str) {
        ...
        if (this.mWeakRecordListener != null) {
            e eVar = (e) this.mWeakRecordListener.get();
            if (eVar != null) {
        ...
        if (this.mEffectorObj > 0) {
            ...
            if (this.mHWEcoder == null) {
                ...
                while (true) {
                    ...
                    if (listener != null) {
                        listener.onRecordEncData(nativeReadOneEncFrame, j3, this.mSampleRate, this.mChannels, this.mBits);
                    }
                ...
                j3 = j2;
                do {
                    nativeReadOneEncFrame = nativeReadOneFrame(this.mEffectorObj, ((this.mChannels * 1024) * this.mBits) / 8);
                    if (nativeReadOneEncFrame != null) {
                        this.mLastPTS = j3;
                        if (this.mHWEcoder != null) {
