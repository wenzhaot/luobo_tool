        ...
        if (this.mIsPlaying) {
            if (this.mJitterBuffer == 0) {
                ...
                if (this.mJitterBuffer != 0) {
                    ...
                    nativeSetSmoothSpeed(this.mJitterBuffer, com.tencent.liteav.basic.d.b.a().b("Audio", "SmoothSpeed"));
                    nativeSetJitterCycle(this.mJitterBuffer, com.tencent.liteav.basic.d.b.a().a("Audio", "LIVE_JitterCycle"));
                    nativeSetRealtimeJitterCycle(this.mJitterBuffer, com.tencent.liteav.basic.d.b.a().a("Audio", "RTC_JitterCycle"));
                    nativeSetLoadingThreshold(this.mJitterBuffer, com.tencent.liteav.basic.d.b.a().a("Audio", "LoadingThreshold"));
                } else {
