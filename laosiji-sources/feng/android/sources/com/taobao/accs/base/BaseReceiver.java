...
public class BaseReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (this.baseReceiver == null) {
            try {
                this.baseReceiver = (IBaseReceiver) a.a().a(StubApp.getOrigApplicationContext(context.getApplicationContext())).loadClass(Constants.RECEIVER_IMPL_NAME).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            } catch (Throwable e) {
                Throwable th = e;
                th.printStackTrace();
                try {
