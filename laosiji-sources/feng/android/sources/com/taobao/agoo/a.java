            ...
            if (this.a != null) {
                ...
                if (TextUtils.isEmpty(access$000) || TextUtils.isEmpty(this.b.msgSource)) {
                    ...
                    if (this.b.agooFactory == null) {
                        ...
                        this.b.agooFactory.init(StubApp.getOrigApplicationContext(this.b.getApplicationContext()), this.b.notifyManager, null);
                    }
                    ...
                    try {
                        ...
                        this.b.agooFactory.saveMsg(access$000.getBytes("UTF-8"), PushConstants.PUSH_TYPE_UPLOAD_LOG);
