...
public class h {
    ...
    public static final String E = ("当前处于页面自动统计模式，@页面的onPageStart手动调用可能导致Activity页面数据重复统计。|可以调用MobclickAgent.openActivityDurationTrack(false)来切换到手动页面统计模式。详见链接 " + UMLogUtils.makeUrl("66975"));
    public static final String F = ("当前处于页面自动统计模式，@页面的onPageEnd手动调用可能导致Activity页面数据重复统计。|可以调用MobclickAgent.openActivityDurationTrack(false)来切换到手动页面统计模式。详见链接 " + UMLogUtils.makeUrl("66975"));
    public static final String G = ("对于页面@，onPageStart和onPageEnd调用对的参数不一致。|对于同一个页面，请先调用onPageStart，再调用onPageEnd。详见链接 " + UMLogUtils.makeUrl("66975"));
    public static final String H = ("对于页面@，请确保先依序成对调用onPageStart，onPageEnd接口，再调用onPageStart接口对其它页面进行统计。|对于任意一个页面，必须依序成对调用onPageStart以及onPageEnd，不能有遗漏。详见链接 " + UMLogUtils.makeUrl("66975"));
    public static final String I = ("对于页面@，请检查是否遗漏onPageStart接口调用。|对于任意一个页面，必须依序成对调用onPageStart以及onPageEnd，不能有遗漏。详见链接 " + UMLogUtils.makeUrl("66975"));
    public static final String J = ("当前发送策略为：启动时发送。详见链接 " + UMLogUtils.makeUrl("66976"));
    public static final String K = ("当前发送策略为: 间隔发送。间隔时间为：@秒。详见链接 " + UMLogUtils.makeUrl("66976"));
    public static final String L = ("当前发送策略为: 集成测试。但是SDK未切换到调试模式，所以后台设置未生效。|如想切换到集成测试发送策略，请调用UMConfigure.setLogEnabled(true)将SDK切换到调试模式。详见链接 " + UMLogUtils.makeUrl("66976"));
    public static final String M = ("当前发送策略为：集成测试。详见链接 " + UMLogUtils.makeUrl("66976"));
    ...
    public static final String aA = ("onAppPause接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String aB = ("level参数为空|level参数不能为空，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aC = ("level参数超出64 chars|level参数不能超出64 chars，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aD = ("level参数为空|level参数不能为空，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aE = ("level参数超出64 chars|level参数不能超出64 chars，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aF = ("level参数为空|level参数不能为空，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aG = ("level参数超出64 chars|level参数不能超出64 chars，详见问题连接：" + UMLogUtils.makeUrl("67341"));
    public static final String aH = ("money参数小于0或coin参数小于0|money参数不能小于0或coin参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67342"));
    ...
    public static final String aJ = ("source参数小于等于0或source参数大于等于100|source参数不能小于等于0或source参数不能大于等于100，详见问题链接：" + UMLogUtils.makeUrl("67342"));
    public static final String aK = ("money参数小于0或number参数小于0或price参数小于0|money参数不能小于0或number参数不能小于0或price参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67342"));
    public static final String aL = ("item参数为空|item参数不能为空，详见问题链接：" + UMLogUtils.makeUrl("67342"));
    public static final String aM = ("currencyAmount参数小于0或virtualAmount参数小于0|currencyAmount参数不能小于0或virtualAmount参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67343"));
    public static final String aN = ("channel参数小于0或channel参数大于等于100|channel参数不能小于0或channel参数不能大于等于100，详见问题链接：" + UMLogUtils.makeUrl("67343"));
    public static final String aO = ("item参数为空|item参数不能为空，详见问题链接：" + UMLogUtils.makeUrl("67344"));
    public static final String aP = ("number参数小于0或price参数小于0|number参数不能小于0或price参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67344"));
    public static final String aQ = ("coin参数小于0|coin参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67345"));
    public static final String aR = ("source参数小于0或source参数大于等于100|source参数不能小于0或source参数不能大于等于100，详见问题链接：" + UMLogUtils.makeUrl("67345"));
    public static final String aS = ("item参数为空|item参数不能为空，详见问题链接：" + UMLogUtils.makeUrl("67345"));
    public static final String aT = ("number参数小于0或price参数小于0|number参数不能小于0或price参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67345"));
    public static final String aU = ("source参数小于0或source参数大于等于100|source参数不能小于0或source参数不能大于等于100，详见问题链接：" + UMLogUtils.makeUrl("67345"));
    public static final String aV = ("item参数为空|item参数不能为空，详见问题链接：" + UMLogUtils.makeUrl("67346"));
    public static final String aW = ("number参数小于0或price参数小于0|number参数不能小于0或price参数不能小于0，详见问题链接：" + UMLogUtils.makeUrl("67346"));
    ...
    public static final String ar = ("startLevel接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String as = ("finishLevel接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String at = ("failLevel接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String au = ("pay接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String av = ("exchange接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String aw = ("buy接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String ax = ("use接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String ay = ("bonus接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    public static final String az = ("onAppResume接口调用非法。|当前处于非Game场景中，不能使用Game相关接口，详见问题连接：" + UMLogUtils.makeUrl("67340"));
    ...
    public static final String h = ("事件属性集合map中key为null|事件属性集合参数map中key不能为null。详见问题链接 " + UMLogUtils.makeUrl("66946"));
