...
class d extends SQLiteOpenHelper {
    ...
    public void a() {
        try {
            ...
            if (!f.a(e.a, writableDatabase)) {
                d(writableDatabase);
            }
            if (!f.a(com.umeng.analytics.pro.c.d.a, writableDatabase)) {
                c(writableDatabase);
            }
            if (!f.a(c.a, writableDatabase)) {
                b(writableDatabase);
            }
            if (!f.a(com.umeng.analytics.pro.c.a.a, writableDatabase)) {
                a(writableDatabase);
            }
        } catch (Exception e) {
        }
