...
public class UMLog {
    ...
    private static final String FIRST = "share";
    ...
    public static void aq(String str, String str2, int i, String str3, String[] strArr, String[] strArr2, String[] strArr3, String[] strArr4) {
        try {
            ...
            if (UMLogImp.logMap != null) {
                String str5 = (String) UMLogImp.logMap.get(str2);
                    ...
                    if (split != null && split.length >= 2) {
                        ...
                        if (strArr3 != null && strArr3.length > 0 && strArr4 != null && strArr4.length > 0) {
                            ...
                            while (i2 < strArr3.length && i2 < strArr4.length) {
                                split[1] = split[1].replace(strArr3[i2], strArr4[i2]);
                                i2++;
                            }
                        }
                        UInterface logger = getLogger(i);
            ...
            if (UMLogImp.logMap != null) {
                ...
                if (!TextUtils.isEmpty(str5)) {
                    if (strArr != null && strArr.length > 0 && strArr2 != null && strArr2.length > 0) {
                        int i2 = 0;
                        while (i2 < strArr.length && i2 < strArr2.length) {
                            String replace = str5.replace(strArr[i2], strArr2[i2]);
                            i2++;
                            str5 = replace;
                        }
                    }
