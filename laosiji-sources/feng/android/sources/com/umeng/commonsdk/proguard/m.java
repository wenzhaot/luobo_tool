...
public final class m {
    ...
    private static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return m.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return m.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return m.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return m.a((byte[]) obj, (byte[]) obj2);
            }
            return m.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static String a(byte b) {
        return Integer.toHexString((b | AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS) & 511).toUpperCase().substring(1);
    }
