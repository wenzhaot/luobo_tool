...
public final class Base64 {
    ...
    private static byte[] codes = new byte[AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS];

    static {
        int i;
        for (i = 0; i < AbstractMessageHandler.MESSAGE_TYPE_PUSH_SWITCH_STATUS; i++) {
            codes[i] = (byte) -1;
        }
        for (i = 65; i <= 90; i++) {
            codes[i] = (byte) (i - 65);
