...
public class ShareBoardConfig {
    ...
    private void setDefaultValue() {
        ...
        setMenuItemBackgroundColor(Color.parseColor(str), Color.parseColor(str2));
        setMenuItemIconPressedColor(Color.parseColor(str2));
        setMenuItemTextColor(parseColor);
        setCancelButtonText("取消分享");
        setCancelButtonTextColor(parseColor);
        setCancelButtonBackground(Color.parseColor(str), Color.parseColor(str2));
    ...
    public ShareBoardConfig setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    int calculateMenuHeightInDp(int i) {
        ...
        if (i <= this.mMenuColumnNum) {
            i2 = 1;
        } else if (i <= this.mMenuColumnNum * 2) {
        }
