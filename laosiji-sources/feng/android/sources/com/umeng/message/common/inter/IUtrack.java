...
public interface IUtrack {
    void addAlias(String str, String str2, JSONObject jSONObject, ICallBack iCallBack) throws Exception;

    void deleteAlias(String str, String str2, JSONObject jSONObject, ICallBack iCallBack) throws Exception;
    ...
    void setAlias(String str, String str2, JSONObject jSONObject, ICallBack iCallBack) throws Exception;

    void trackAppLaunch(JSONObject jSONObject) throws Exception;

    void trackLocation(JSONObject jSONObject) throws Exception;

    void trackRegister(JSONObject jSONObject) throws Exception;
}
