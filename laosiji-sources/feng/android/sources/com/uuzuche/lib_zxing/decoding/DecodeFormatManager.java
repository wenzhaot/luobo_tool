...
public class DecodeFormatManager {
    ...
    public static final Vector<BarcodeFormat> DATA_MATRIX_FORMATS = new Vector(1);
    public static final Vector<BarcodeFormat> ONE_D_FORMATS = new Vector(PRODUCT_FORMATS.size() + 4);
    public static final Vector<BarcodeFormat> PRODUCT_FORMATS = new Vector(5);
    public static final Vector<BarcodeFormat> QR_CODE_FORMATS = new Vector(1);
