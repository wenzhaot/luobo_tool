...
class a implements XmlSerializer {
    ...
    /* renamed from: a */
    private OutputStream f8a;
    /* renamed from: a */
    private Writer f9a;
    /* renamed from: a */
    private ByteBuffer f10a = ByteBuffer.allocate(8192);
    /* renamed from: a */
    private CharsetEncoder f11a;
    /* renamed from: a */
    private final char[] f12a = new char[8192];
    private boolean f;
    private int mPos;
    ...
    public void startDocument(String encoding, Boolean standalone) throws IOException, IllegalArgumentException, IllegalStateException {
        append("<?xml version='1.0' encoding='utf-8' standalone='" + (standalone.booleanValue() ? "yes" : NotifyOption.NOTIFY_OPTION) + "' ?>\n");
    }
