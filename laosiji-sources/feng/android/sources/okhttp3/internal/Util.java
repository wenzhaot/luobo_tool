...
public final class Util {
    ...
    public static final Charset ISO_8859_1 = Charset.forName(f.a);
    public static final Comparator<String> NATURAL_ORDER = new 1();
    public static final TimeZone UTC = TimeZone.getTimeZone("GMT");
    private static final Charset UTF_16_BE = Charset.forName(f.d);
    private static final ByteString UTF_16_BE_BOM = ByteString.decodeHex("feff");
    private static final Charset UTF_16_LE = Charset.forName(f.e);
    ...
    public static boolean skipAll(Source source, int duration, TimeUnit timeUnit) throws IOException {
        ...
        try {
            ...
            while (source.read(skipBuffer, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) != -1) {
                skipBuffer.clear();
            }
        ...
        while (i < limit) {
            ...
            if (i + 2 <= limit && input.regionMatches(i, "::", 0, 2)) {
                ...
                if (input.regionMatches(i, ":", 0, 1)) {
                    i++;
                } else if (!input.regionMatches(i, FileUtils.FILE_EXTENSION_SEPARATOR, 0, 1)) {
                    return null;
                } else {
