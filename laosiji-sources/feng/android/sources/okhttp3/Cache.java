...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class Entry {
        ...
        public Response response(Snapshot snapshot) {
            ...
            String contentLength = this.responseHeaders.get(HttpRequest.HEADER_CONTENT_LENGTH);
    ...
    CacheRequest put(Response response) {
        ...
        } else if (!requestMethod.equals(HttpRequest.METHOD_GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
