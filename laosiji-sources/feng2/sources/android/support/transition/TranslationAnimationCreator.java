...
class TranslationAnimationCreator {
    ...
    static Animator createAnimation(View view, TransitionValues values, int viewPosX, int viewPosY, float startX, float startY, float endX, float endY, TimeInterpolator interpolator) {
        ...
        propertyValuesHolderArr[0] = PropertyValuesHolder.ofFloat(View.TRANSLATION_X, new float[]{startX, endX});
        propertyValuesHolderArr[1] = PropertyValuesHolder.ofFloat(View.TRANSLATION_Y, new float[]{startY, endY});
        Animator anim = ObjectAnimator.ofPropertyValuesHolder(view, propertyValuesHolderArr);
