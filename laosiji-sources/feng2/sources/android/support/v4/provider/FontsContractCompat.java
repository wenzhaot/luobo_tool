...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri uri = new Builder().scheme(UriUtil.LOCAL_CONTENT_SCHEME).authority(authority).build();
        Uri fileBaseUri = new Builder().scheme(UriUtil.LOCAL_CONTENT_SCHEME).authority(authority).appendPath(UriUtil.LOCAL_FILE_SCHEME).build();
        Cursor cursor = null;
        try {
