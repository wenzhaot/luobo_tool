...
public final class MediaBrowserCompat {
    ...
    private static class CallbackHandler extends Handler {
        ...
        L_0x0016:
            r1 = r9.getData();
            r4 = android.support.v4.media.session.MediaSessionCompat.class;
            r4 = r4.getClassLoader();
            r1.setClassLoader(r4);
            r4 = r8.mCallbackImplRef;
            r3 = r4.get();
            r3 = (android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl) r3;
            r4 = r8.mCallbacksMessengerRef;
            r0 = r4.get();
            r0 = (android.os.Messenger) r0;
            r4 = r9.what;	 Catch:{ BadParcelableException -> 0x006c }
            switch(r4) {
        ...
        L_0x0038:
            ...
            r5 = new java.lang.StringBuilder;	 Catch:{ BadParcelableException -> 0x006c }
            r5.<init>();	 Catch:{ BadParcelableException -> 0x006c }
            r6 = "Unhandled message: ";
            r5 = r5.append(r6);	 Catch:{ BadParcelableException -> 0x006c }
            r5 = r5.append(r9);	 Catch:{ BadParcelableException -> 0x006c }
            r6 = "\n  Client version: ";
            r5 = r5.append(r6);	 Catch:{ BadParcelableException -> 0x006c }
            r6 = 1;
            r5 = r5.append(r6);	 Catch:{ BadParcelableException -> 0x006c }
            r6 = "\n  Service version: ";
            r5 = r5.append(r6);	 Catch:{ BadParcelableException -> 0x006c }
            r6 = r9.arg1;	 Catch:{ BadParcelableException -> 0x006c }
            r5 = r5.append(r6);	 Catch:{ BadParcelableException -> 0x006c }
            r5 = r5.toString();	 Catch:{ BadParcelableException -> 0x006c }
            android.util.Log.w(r4, r5);	 Catch:{ BadParcelableException -> 0x006c }
            goto L_0x0015;
        L_0x006c:
            r2 = move-exception;
            r4 = "MediaBrowserCompat";
            r5 = "Could not unparcel the data.";
        ...
        L_0x007e:
            ...
            r5 = r1.getString(r4);	 Catch:{ BadParcelableException -> 0x006c }
            r4 = "data_media_session_token";
            r4 = r1.getParcelable(r4);	 Catch:{ BadParcelableException -> 0x006c }
            r4 = (android.support.v4.media.session.MediaSessionCompat.Token) r4;	 Catch:{ BadParcelableException -> 0x006c }
            r6 = "data_root_hints";
            r6 = r1.getBundle(r6);	 Catch:{ BadParcelableException -> 0x006c }
        ...
        L_0x009f:
            r4 = "data_media_item_id";
            r4 = r1.getString(r4);	 Catch:{ BadParcelableException -> 0x006c }
            r5 = "data_media_item_list";
            r5 = r1.getParcelableArrayList(r5);	 Catch:{ BadParcelableException -> 0x006c }
            r6 = "data_options";
            r6 = r1.getBundle(r6);	 Catch:{ BadParcelableException -> 0x006c }
