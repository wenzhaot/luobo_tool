...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(widthUsed, widthMeasureSpec, ViewCompat.MEASURED_STATE_MASK & childState), View.resolveSizeAndState(heightUsed, heightMeasureSpec, childState << 16));
    }
