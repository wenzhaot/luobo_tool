...
public class ConstrainedExecutorService extends AbstractExecutorService {
     ...
     */
        public void run() {
            /*
            r7 = this;
            r2 = com.facebook.common.executors.ConstrainedExecutorService.this;	 Catch:{ all -> 0x003e }
            r2 = r2.mWorkQueue;	 Catch:{ all -> 0x003e }
        ...
        L_0x002c:
            return;
        L_0x002d:
            r2 = com.facebook.common.executors.ConstrainedExecutorService.TAG;	 Catch:{ all -> 0x003e }
            r3 = "%s: Worker has nothing to run";
            r4 = com.facebook.common.executors.ConstrainedExecutorService.this;	 Catch:{ all -> 0x003e }
            r4 = r4.mName;	 Catch:{ all -> 0x003e }
            com.facebook.common.logging.FLog.v(r2, r3, r4);	 Catch:{ all -> 0x003e }
            goto L_0x0011;
        L_0x003e:
            r2 = move-exception;
        ...
        L_0x005b:
            ...
            com.facebook.common.logging.FLog.v(r2, r3, r4, r5);
            goto L_0x002c;
        L_0x0070:
            ...
            com.facebook.common.logging.FLog.v(r3, r4, r5, r6);
            goto L_0x005a;
            */
