...
public class EmptyJpegGenerator {
    ...
    public CloseableReference<PooledByteBuffer> generate(short width, short height) {
        ...
        try {
            ...
            CloseableReference<PooledByteBuffer> of = CloseableReference.of(os.toByteBuffer());
            if (os != null) {
                os.close();
            }
            return of;
