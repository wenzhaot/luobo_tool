...
public class DiskCacheProducer implements Producer<EncodedImage> {
    ...
    private class DiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        /* synthetic */ DiskCacheConsumer(DiskCacheProducer x0, Consumer x1, BufferedDiskCache x2, CacheKey x3, AnonymousClass1 x4) {
            this(x1, x2, x3);
        }
        ...
        return new Continuation<EncodedImage, Void>() {
            public Void then(Task<EncodedImage> task) throws Exception {
                if (DiskCacheProducer.isTaskCancelled(task)) {
                    ...
                    DiskCacheProducer.this.maybeStartInputProducer(consumer2, new DiskCacheConsumer(DiskCacheProducer.this, consumer2, bufferedDiskCache, cacheKey, null), producerContext2);
                } else {
