            ...
            if (bucket != null) {
                ...
                if (value != null) {
                    ...
                    if (FLog.isLoggable(2)) {
                        FLog.v(this.TAG, "get (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSize));
                    }
                }
            }
            sizeInBytes = getSizeInBytes(bucketedSize);
    ...
    void trimToNothing() {
        ...
        synchronized (this) {
            for (i = 0; i < this.mBuckets.size(); i++) {
                bucket = (Bucket) this.mBuckets.valueAt(i);
