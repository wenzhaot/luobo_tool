...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback, MemoryUiTrimmable {
    ...
    public void trim() {
        this.mEventTracker.recordEvent(Event.ON_HOLDER_TRIM);
        this.mTrimmed = true;
        attachOrDetachController();
    }

    public void untrim() {
        this.mEventTracker.recordEvent(Event.ON_HOLDER_UNTRIM);
        this.mTrimmed = false;
        attachOrDetachController();
    }
    ...
    public String toString() {
        return Objects.toStringHelper((Object) this).add("controllerAttached", this.mIsControllerAttached).add("holderAttached", this.mIsHolderAttached).add("drawableVisible", this.mIsVisible).add("trimmed", this.mTrimmed).add("events", this.mEventTracker.toString()).toString();
    }
}
