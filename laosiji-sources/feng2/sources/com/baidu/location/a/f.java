...
public class f {
    ...
    private static boolean a(int i, int i2, int i3) {
        return (i < 0 || i > k.ad) ? false : (i2 < 0 || i2 > i + 1) ? false : i3 >= 1 && i3 <= i + 1 && i3 <= k.ad;
    }

    private boolean a(Location location, int i, int i2) {
        if (location == null || !k.Z || !this.q) {
            return false;
        }
        if (k.ab < 5) {
            k.ab = 5;
        ...
        long j = time - h;
        if (fArr[0] < ((float) k.ab) && j < ((long) k.ac)) {
            return false;
        }
        if (d == null) {
            f++;
    ...
    private boolean a(String str) {
        ...
        try {
            ...
            if (a(readInt, readInt2, readInt3)) {
                if (k.aa) {
                    if (readInt == k.ad) {
                        if (str.equals(a(readInt3 == 1 ? k.ad : readInt3 - 1))) {
                            randomAccessFile.close();
                            return false;
                        }
                ...
                if (readInt == 0) {
                    ...
                    randomAccessFile.seek(0);
                    randomAccessFile.writeInt(k.ad);
                    ...
                    readInt = readInt3 == k.ad ? 1 : readInt3 + 1;
                    i = readInt == k.ad ? 1 : readInt + 1;
    ...
    public static String b() {
        ...
        try {
            ...
            if (!a(readInt, readInt2, readInt3)) {
                ...
                readInt3 = readInt < k.ad ? readInt2 + 1 : readInt2 == k.ad ? 1 : readInt2 + 1;
                randomAccessFile.seek(4);
